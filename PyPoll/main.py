...
voter_id=[]
# county not technically needed.  Do not use in operations but at begining thought it would be good to store in list.
# county=[]
candidate =[]
can_list = []
winner = []
...
# Calculate total votes, start print statement including total votes
...
# create loop to associate each candidate in list of candidates the index value of my ordered candidate list
...
## End help from Hunter Carlisle.   
    #store winner vote tally using max function
    if votes == max(can_votes):
        #Append to winner list as string to print later and write into text file
        winner.append(f'Winner: {can}')
print("-------------------------")
print(winner)
print("-------------------------")

# Create Output path and where to write the file
